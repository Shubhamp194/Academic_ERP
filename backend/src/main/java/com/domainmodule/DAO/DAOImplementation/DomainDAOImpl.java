...
public class DomainDAOImpl implements DomainDAO {
    ...
    public boolean modifyDomain(int domId, Domain domObj) {
        try (Session session = HibernateSessionUtil.getSession()) {
            ...
            Query q = session.createQuery("update Domain set  program=:p, capacity=:c,qualification=:qu,batch=:b where domain_id=:id");
            q.setParameter("qu", domObj.getQualification());
            q.setParameter("c", domObj.getCapacity());
            q.setParameter("p",domObj.getProgram());
            q.setParameter("b",domObj.getBatch());
            q.setParameter("id",domId);
